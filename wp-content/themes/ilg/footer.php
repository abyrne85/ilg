...
?>
<footer class="site-footer" <?php echo (!empty($bg)) ? 'style="background: url(\''.$bg.'\')"' : ''; ?> role="contentinfo">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-4 col-sm-6 col-xs-6">
                <?php if($footer_socials):?>
                    <div class="widget widget-social-links">
                        <h3 class="widget-title"><?php _e('Elsewhere on the Web','tfuse');?></h3>
                   ...
                   <ul class="footer-social">
                       <?php if(!empty($fb)):?>
                           <li><a  href="<?php echo $fb;?>" target="_blank"><i class="icon-facebook"></i><span style="position:absolute;bottom:-1000px;">Find us on Facebook</span></a></li>
                       <?php endif;?>
                        <?php if(!empty($g)):?>
                           <li><a href="<?php echo $g;?>" target="_blank"><i class="icon-google-plus"></i><span style="position:absolute;bottom:-1000px;">Find us on Google Plus</span></a></li>
                       <?php endif;?>
                       <?php if(!empty($tw)):?>
                           <li><a href="<?php echo $tw;?>" target="_blank"><i class="icon-twitter"></i><span style="position:absolute;bottom:-1000px;">Find us on Twitter</span></a></li>
                       <?php endif;?>
                       <?php if(!empty($skype)):?>
                           <li><a href="skype:<?php echo $skype;?>?chat"><i class="icon-skype"></i><span style="position:absolute;bottom:-1000px;">Chat with us on Skype</span></a></li>
                       <?php endif;?>
